 ...
 */
public class IncomeOrderActivity extends BaseActivity<IMainOrderView, MMainOrderPresenter> implements IMainOrderView {
	...
	protected void init() {
		...
		dayNear = bundle.getInt(ValueKey.DayNearly);
	}
	@Override
	protected void initToolbar() {
		// TODO Auto-generated method stub
		super.initToolbar();
		setToolbar(R.id.toolbar_main_order,title);
	}
	...
	private void setRecyclerView() {
		...
		//
		mAdapter = new MainOrderAdapter(mActivity);
