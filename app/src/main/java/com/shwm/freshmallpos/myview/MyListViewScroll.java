 ...
 * 
 */
public class MyListViewScroll extends ListView {

	public MyListViewScroll(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MyListViewScroll(Context context) {
		super(context);
	}

	public MyListViewScroll(Context context, AttributeSet attrs, int defStyle) {
