 ...
 * 
 * @return The path of the directory holding application files on external storage. Returns null if external storage is
...
public class SDPathUtil {
	...
	public static String getSDCardPrivateCacheDir(Context context,String filename) {
		if (isSDCardMounted()) {
			// /mnt/sdcard/Android/data/com.my.app/cache
